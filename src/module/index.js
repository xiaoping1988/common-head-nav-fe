...
export default {
    ...
    initContainer: function () {
        ...
        container.innerHTML = '<div id="commonHeadLogo"><a href="/">一条龙</a></div><ul id="commonHeadMenu"></ul><div id="commonHeadSearchContainer"><div id="commonHeadSearch"></div></div><div id="commonHeadMessage"></div><div id="commonHeadUser"></div>'
